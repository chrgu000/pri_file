...
public class ApiException extends TException implements org.apache.thrift.TBase<ApiException, ApiException._Fields>, java.io.Serializable, Cloneable, Comparable<ApiException> {
  ...
  static {
    schemes.put(StandardScheme.class, new ApiExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ApiExceptionTupleSchemeFactory());
  }
  ...
  public ApiException setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  private static class ApiExceptionStandardSchemeFactory implements SchemeFactory {
    public ApiExceptionStandardScheme getScheme() {
      return new ApiExceptionStandardScheme();
    }
  }

  private static class ApiExceptionStandardScheme extends StandardScheme<ApiException> {
  ...
  private static class ApiExceptionTupleSchemeFactory implements SchemeFactory {
    public ApiExceptionTupleScheme getScheme() {
      return new ApiExceptionTupleScheme();
    }
  }

  private static class ApiExceptionTupleScheme extends TupleScheme<ApiException> {
